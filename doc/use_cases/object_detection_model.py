...
class YOLO2MODEL:
    def __init__(self):
        ...
        self.CLASS_WEIGHTS    = np.ones(self.CLASSES, dtype='float32')
    ...
    def build(self):
        ...
        # Layer 23
        x = Conv2D(self.BOX * (4 + 1 + self.CLASSES), (1,1), strides=(1,1), padding='same', name='conv_23')(x)
        output = Reshape((self.GRID_H, self.GRID_W, self.BOX, 4 + 1 + self.CLASSES))(x)
